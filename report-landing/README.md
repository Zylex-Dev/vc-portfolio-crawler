...
│  ├─ App.tsx                # hero, контролы, 3 вида, блок «новые идеи»
│  ├─ types.ts               # доменные типы
│  ├─ theme.ts               # палитра, статусы, форматирование
│  ├─ lib/report.ts          # группировка стартапов по агентам + агрегаты
│  ├─ components/
│  │  ├─ Drawer.tsx          # боковая панель группы + карточки стартапов
│  │  └─ shared.tsx          # переиспользуемые UI-элементы
